...

            {
                ...
                <>
                    ...
                    <div className='info'>
                        ...
                        <h4 className='title'><Link>{productData.name.substr(0,50)+'...'}</Link></h4>
                        ...
                        <div className='d-flex align-items-center mt-3'>
                            <div className='d-flex align-items-center w-100'>
                                <span className='price text-g font-weight-bold'>
                                  {productData.price} Fcfa</span> <span className='oldPrice ml-auto'> {productData.oldPrice} Fcfa</span>
                            </div>
                        </div>
